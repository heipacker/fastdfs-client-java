  		...
  		*/
            ...
            for (StructGroupStat groupStat : groupStats) {
                ...
                for (StructStorageStat storageStat : storageStats) {
                    ...
                    System.out.println("\t\tipAddr = " + storageStat.getIpAddr() + "  " + ProtoCommon.getStorageStatusCaption(storageStat.getStatus()));
                    ...
                    System.out.println("\t\tsource ipAddr = " + storageStat.getSrcIpAddr());
