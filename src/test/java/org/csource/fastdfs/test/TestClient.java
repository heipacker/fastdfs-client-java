        ...
        try {
  		...
  		*/
            if (results == null) {
                ...
                startTime = System.currentTimeMillis();
                errno = storageClient.set_metadata(group_name, remote_filename, meta_list, ProtoCommon.STORAGE_SET_METADATA_FLAG_MERGE);
                ...
                meta_list = storageClient.get_metadata(group_name, remote_filename);
                if (meta_list != null) {
                ...
                file_ext_name = "txt";
                startTime = System.currentTimeMillis();
                results = storageClient.upload_file(group_name, master_filename, prefix_name, file_buff, file_ext_name, meta_list);
                System.out.println("upload_file time used: " + (System.currentTimeMillis() - startTime) + " ms");
                if (results != null) {
                    ...
                    System.err.println(storageClient.get_file_info(results[0], results[1]));
                }
            ...
            results = storageClient.upload_file(local_filename, null, meta_list);
            if (results != null) {
                String file_id;
                int ts;
                String token;
                ...
                file_ext_name = null;
                startTime = System.currentTimeMillis();
                results = storageClient.upload_file(group_name, master_filename, prefix_name, local_filename, null, meta_list);
                System.out.println("upload_file time used: " + (System.currentTimeMillis() - startTime) + " ms");
                if (results != null) {
                    System.err.println("slave file group_name: " + results[0] + ", remote_filename: " + results[1]);
            ...
            results = storageClient.upload_file(null, f.length(),
            ...
            if (results != null) {
                ...
                prefix_name = "-part3";
                startTime = System.currentTimeMillis();
                results = storageClient.upload_file(group_name, master_filename, prefix_name, f.length(), new UploadLocalFileSender(local_filename), file_ext_name, meta_list);
                System.out.println("upload_file time used: " + (System.currentTimeMillis() - startTime) + " ms");
                if (results != null) {
                    System.err.println("slave file group_name: " + results[0] + ", remote_filename: " + results[1]);
