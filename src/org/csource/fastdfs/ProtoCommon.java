...
public class ProtoCommon {
     ...
     * @return token string
     */
    public static String getToken(String remote_filename, int ts, String secret_key) throws UnsupportedEncodingException, NoSuchAlgorithmException, FastDFSClientException {
    ...
    public static String genSlaveFilename(String master_filename,
                                          String prefix_name, String ext_name) throws FastDFSClientException {
        String true_ext_name;
        int dotIndex;

        if (master_filename.length() < 28 + FDFS_FILE_EXT_NAME_MAX_LEN) {
            throw new FastDFSClientException("master filename \"" + master_filename + "\" is invalid");
        }
        ...
        if (true_ext_name.length() == 0 && prefix_name.equals("-m")) {
            throw new FastDFSClientException("prefix_name \"" + prefix_name + "\" is invalid");
        }
